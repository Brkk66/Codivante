...
import { ArrowRight, Code2, Palette, Rocket, Users, Mail, Phone, MapPin, CheckCircle2, Star, Menu, X, Loader2 } from 'lucide-react';
...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.message) {
      toast.error('Vul alle velden in alsjeblieft');
      return;
    }
    ...
    try {
      ...
      toast.error('Er is iets misgegaan. Probeer het later opnieuw of mail direct naar info@codivante.com');
    } finally {
